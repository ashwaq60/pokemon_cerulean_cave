...
rl.question('Do you want to enter Pokemon Cerulean Cave? yes/no \n',
    (userInput) => {
        ...
        // else {
        //     console.log(`You've proceeded ahead straight in the dark ... you have fallen down a 10ft hole.`)
        //     rl.close();
        // }
    })
